...
$(function () {
    ...
    /*web start*/
    $.get(Urls.RootPath + "account/ajaxlogoninfo/", { rn: Math.random() }, function (re) {
    ...
    $("#searchBtn").click(function () {
        if ($.trim($("#searchKey").val()) != "") {
            window.location.href = Urls.RootPath + "search/" + $.trim($("#searchKey").val()).replace(/\./g, "");
        }
    });
    ...
    $('#BtnLogon').on('click', function () {
        ...
        if ($.trim(tar.val()) == "") {
            ...
            tar.siblings('.form_tip').html(lang.UserNameCanNotBeEmpty).show();
            valid = false;
        }
        tar = $('#Password');
        if ($.trim(tar.val()) == "") {
            tar.addClass("form_error");
            tar.siblings('.form_tip').html(lang.PasswordCanNotBeEmpty).show();
            valid = false;
        }
        ...
        if (valid) {
            ...
            $.ajax({
                url: Urls.RootPath + "account/logon/",
                type: "post",
                data: form.serialize(),
                success: function (re) {
    ...
    $('#BtnRegister').on('click', function () {
        ...
        if ($.trim(tar.val()) != "" && $.trim(tar.val()).length < 6) {
            tar.addClass("form_error");
            tar.siblings('.form_tip').html(lang.PasswordLengthLimit).show();
            valid = false;
        }
        tar = $('#ConfirmPassword');
        if ($.trim(tar.val()) == "") {
            tar.addClass("form_error");
            tar.siblings('.form_tip').html(lang.ConfirmPasswordCanNotBeEmpty).show();
            valid = false;
        }
        if ($.trim(tar.val()) != "" && $.trim(tar.val()) != $.trim($('#Password').val())) {
            tar.addClass("form_error");
            tar.siblings('.form_tip').html(lang.ConfirmPasswordNotEqual).show();
            valid = false;
        }
        var loadingWrap = $(this).closest(".loadingwrap");
        if (valid) {
            loadingWrap.append(loadingImgSmall);
            $.ajax({
                url: Urls.RootPath + "account/register/",
                type: "post",
                data: form.serialize(),
                success: function (re) {
    ...
    $('#BtnUserProfile').on('click', function () {
        ...
        if (valid) {
            $.ajax({
                url: Urls.RootPath + "account/userprofile/",
                type: "post",
                data: form.serialize(),
                success: function (re) {
                    if (re == "") {
                        Go(Urls.RootPath + "account/ucenter/");
                    } else {
                        form.find('.summary_tip').html(re);
                        form.find('.summary_tip_wrap').show();
                    }
    ...
    $('#BtnChangePassword').on('click', function () {
        ...
        if ($.trim(tar.val()) == "") {
            tar.addClass("form_error");
            tar.siblings('.form_tip').html(lang.OldPasswordCanNotEmpty).show();
            valid = false;
        }
        tar = $('#NewPassword');
        if ($.trim(tar.val()) == "") {
            tar.addClass("form_error");
            tar.siblings('.form_tip').html(lang.NewPasswordCanNotEmpty).show();
            valid = false;
        }
        if ($.trim(tar.val()) != "" && $.trim(tar.val()).length < 6) {
            tar.addClass("form_error");
        ...
        var loadingTar = $(this).siblings('.loading');
        if (valid) {
            loadingTar.show();
            $.ajax({
                url: Urls.RootPath + "account/changepassword/",
                type: "post",
                data: form.serialize(),
                success: function (re) {
                    loadingTar.hide();
    ...
    $('.article_comment').on('click', "#BtnCommentSubmit", function () {
        ...
        if ($.trim(tar.val()) == "") {
            tar.addClass("form_error");
            tar.siblings('.form_tip').html(lang.ContentCanNotEmpty).show();
            valid = false;
        }
        if (valid) {
            ...
            $.ajax({
                url: Urls.RootPath + "home/ajaxcomment/",
                type: "post",
                data: form.serialize(),
                dataType: 'json',
                success: function (re) {
    ...
    $('.note').on('click', "#BtnNoteSubmit", function () {
        ...
        if (valid) {
            ...
            $(this).closest(".loadingwrap").append(loadingImgSmall);
            $.ajax({
                url: Urls.RootPath + "home/ajaxnote/",
                type: "post",
                data: form.serialize(),
                dataType: 'json',
                success: function (re) {
...
function GetCommentForm() {
    $.get(Urls.RootPath + "home/ajaxcommentform/", { rn: Math.random() }, function (re) {
